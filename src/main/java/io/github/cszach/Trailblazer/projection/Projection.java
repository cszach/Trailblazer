 ...
 *
 * <p>
 * A projection method can know the width and height of the projection, as well as zoom level. How
 * zoom level is used is up to the implementation.
 */
public interface Projection {
   ...
   *
   * <p>
   * Assumptions about the latitude and longtitude, such as their units or whether they are geodetic
   * or geocentric are left to the implementation.
   *
